...
## 題目：酒鬼地圖
### 內容摘要：為了想小酌卻找不到小酌的地點的大學生，我們要收集高雄的酒吧地點做出一個｢酒鬼地圖網站」來解決此問題
### http://systemanalyst.taichyweb.com
...
|:---|:---:|
|行動者|用戶|
|說明|提供使用者現在位於的地點到酒吧的距離|
|完成動作|1.點選用戶感興趣的酒吧 2.檢視地點內容|
|替代方法|查無此資訊，提示無法檢視訊息|
|先決條件|至酒友地圖選定有興趣的酒吧地點|
|後置條件|查詢結束|
